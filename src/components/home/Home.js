        ...
        return (
            <section className="home-section">
                ...
                <div className="h-100 container flex flex-col items-center justify-center">
                    <div className="box-round bg-pink shadow px-2 py-1 font-lg font-white mb-100">만다라트 (Mandal-Art)</div>
                    <div className=" flex flex-col-m justify-between items-center">
                        ...
                        <div>
                            ...
                            <p className="font-light">
                                ...
                                핵심목표를 세우고 이에 대한 해결점, 아이디어, 생각들을 확산해 나가는 형태로, <span className="font-bold">목표를 계획하거나 아이디어를 구체화</span> 할 때 아주 유용하게 활용할 수
                                있습니다.
                            </p>
                            </div>
