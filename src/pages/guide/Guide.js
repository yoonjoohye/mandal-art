                ...
                <Container>
                    ...
                    <GuideWrapper>
                        ...
                        <GuideBox justifyContent="center">
                            <GuideImg src={require('../../assets/img/mandal.jpg')} alt="만다라트-가이드 이미지"/>
                            <GuideContent>
                                <span className="font-medium">1.</span> <Link className="font-blue font-medium"
                                                                              to="/write"> 만다라트 만들기</Link>를
                                시작합니다.<br/><br/>
