		...
		<Section>
			<Container>
				<div className="mb-20">
					<b>제 1 장 총칙</b>
					<div className="mb-10">
						<div>제 1 조 (목적)</div>본 약관은 윤주혜가 운영하는 웹 사이트
						(http://mandal-art.yoonjoohye.xyz)의 제반 서비스의 이용조건 및
						절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
					</div>

					<div className="mb-10">
						<div>제 2 조 (용어의 정의)</div>본 약관에서 사용하는 용어는 다음과
						같이 정의한다.
						<li>
					...
					<div>
						<div>제 4 조 (약관 외 준칙)</div>본 약관에 명시되지 않은 사항이
				...
				<div className="mb-20">
					...
					<div className="mb-10">
						...
						<li>
							③회사는 아래 사항에 해당하는 경우에 승낙을 하지 않을 수 있다. 가.
							다른 사람의 명의를 사용하여 신청한 경우 나. 이용자 정보를 허위로
							기재하여 신청한 경우 다. 사회의 안녕질서 또는 미풍양속을 저해할
							목적으로 신청한 경우 라. 기타 회사가 정한 이용신청 요건이 미비한
							경우
						</li>
					</div>
				</div>
				...
				<div className="mb-20">
					...
					<div className="mb-10">
						<div>제 12 조 (서비스 이용의 제한)</div>본 사이트 이용 및 행위가
						다음 각 항에 해당하는 경우 회사는 해당 이용자의 이용을 제한할 수
						있다.
				...
				<div className="mb-20">
					...
					<div className="mb-10">
						<div>제17조 (배송정책)</div>
						<li>
							① ‘회사’는 이용자와 재화의 공급시기에 관하여 별도의 약정이 없는
							이상, 이용자가 결재를 실시한 날부터 7일 이내에 재화 등을 배송할 수
							있도록 주문제작, 포장 등 기타의 필요한 조치를 취한다.
						</li>
						<li>
				...
				<div className="mb-20">
					...
					<div className="mb-10">
						...
						<li>
							②회사는 이용자간 또는 이용자와 제3자간의 상호거래 관계에서
							발생되는 결과에 대하여 어떠한 책임도 부담하지 않는다.
						</li>
						<li>
							③회사는 이용자가 게시판에 게재한 정보, 자료, 내용 등에 관하여
							사실의 정확성, 신뢰도 등에 어떠한 책임도 부담하지 않으며 이용자는
							본인의 책임 아래 본 사이트를 이용해야 한다.
						</li>
						<li>
