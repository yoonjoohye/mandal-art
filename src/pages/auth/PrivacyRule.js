    ...
    <Section>
      <Container>
        <div className="mb-20">
          <b className="mb-10">
            1. 개인정보의 처리 목적
            만다라트(‘https://mandal-art.yoonjoohye.xyz’이하 ‘만다라트’) 은(는)
        ...
        <div className="mb-20">
          ...
          <div>
            <li>
              ① 만다라트(‘https://mandal-art.yoonjoohye.xyz’이하 ‘만다라트’)
              은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보
            ...
            <li>
              ...
              정산시까지 - 전자상거래에서의 계약․청약철회, 대금결제, 재화 등
              공급기록 : 5년
            </li>
          </div>
        </div>
        <div className="mb-20">
          ...
          <div>
            <li>
              ...
              '만다라트')은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보
              보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게
              제공합니다.
            </li>

            <li>
              ② 만다라트('https://mandal-art.yoonjoohye.xyz')은(는) 다음과 같이
              개인정보를 제3자에게 제공하고 있습니다.
              <br />
              - 개인정보를 제공받는 자 : 윤주혜
              <br />
              - 제공받는 자의 개인정보 이용목적 : 이메일, 로그인ID, 이름, 서비스
              이용 기록, 쿠키
              <br />- 제공받는 자의 보유.이용기간: 10년
            </li>
          </div>
        </div>
        <div className="mb-20">
          ...
          <div>
            <li>
              ① 만다라트('만다라트')은(는) 원활한 개인정보 업무처리를 위하여
            ...
            <li>
              ② 만다라트('https://mandal-art.yoonjoohye.xyz'이하
              '만다라트')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라
        ...
        <div className="mb-20">
          ...
          <li>
            ① 정보주체는 만다라트(‘https://mandal-art.yoonjoohye.xyz’이하
            ‘만다라트) 에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를
            행사할 수 있습니다.
            <br />
            1. 개인정보 열람요구
            <br />
        ...
        <div className="mb-20">
          <b className="mb-10">
            7. 개인정보의 파기만다라트('만다라트')은(는) 원칙적으로 개인정보
        ...
        <div className="mb-20">
          ...
          <li>
            ① 만다라트 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를
        ...
        <div className="mb-20">
          ...
          <li>
            ② 정보주체께서는 만다라트(‘https://mandal-art.yoonjoohye.xyz’이하
            ‘만다라트) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보
        ...
        <div className="mb-20">
          <b className="mb-10">
            11. 개인정보의 안전성 확보 조치 만다라트('만다라트')은(는)
            개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한
            기술적/관리적 및 물리적 조치를 하고 있습니다.
          </b>
          <li>
            1. 개인정보의 암호화 이용자의 개인정보는 비밀번호는 암호화 되어 저장
